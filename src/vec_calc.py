...
class Vec_Calc:
    ...
    def getAngle(self, v1, v2):
        ...
        Parameters:
            self (Vec_Calc): The object itself.
    ...
    def rotate(self, v1, v2, norm, angl):
        '''
    ...
    def transform(self, v1, v2):
        ...
        a = self.getAngle((0,0,1),v1)

        r1,r2 = self.rotate(v1,v2,n,-np.radians(a))

        return r2

    def getAspect(self, normal):
        '''
